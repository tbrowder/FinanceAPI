...
Note the API key obtained must be assigned to the user's environment variable `FINANCEAPI_KEY`. In a Linux OS one could do this in the user's `$HOME/.bash_aliases` file:

    export FINANCEAPI_KEY='dEfvhygSrfbFttgyhjfe3huj'
